...
The Darcy friction factor ($`f`$) is a key parameter for calculating
head loss. The `hf` package uses a functional programming approach,
allowing users to “inject” different calculation methods into the
Darcy-Weisbach functions.
