...
and $`25^\circ C`$) flowing at standard velocities. It should not be
used for other fluids, very hot water, or extreme flow regimes.
...
The base mathematical equation for head loss ($`h_f`$) in the metric
system is:
``` math
